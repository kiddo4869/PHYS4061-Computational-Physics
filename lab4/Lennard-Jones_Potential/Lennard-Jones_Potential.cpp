...
{   
    ...
    // set lattice constant for Ar atoms
    a = 5.31;               // (unit: A)
    ...
    cout << "\n------------Parameters------------\n";
    cout << "Element = Ar\n";
    cout << "Structure type = FCC\n";
    cout << "Number of atoms = " << n_atoms << "\n";
    ...
    cout << "Lattice Energy per atom using Lennard-Jones potential = " << double(E / n_atoms) << " eV/at\n";
